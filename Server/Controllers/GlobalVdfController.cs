...
namespace OpenWLS.Server.Controllers
{
    ...
    public class GlobalVdfController : ControllerBase
    {
        private readonly ILogger<GlobalVdfController> _logger;
        private readonly IGlobalVDFRepository _rep;
        public GlobalVdfController(IGlobalVDFRepository rep,  ILogger<GlobalVdfController> logger)
        {
            _logger = logger;
            _rep = rep;
        }
